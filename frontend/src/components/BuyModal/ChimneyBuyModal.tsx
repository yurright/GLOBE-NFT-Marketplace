...
import { MINT_CHIMNEY_NFT_CONTRACT } from "../../abis/contractAddress";
...
const Modal: FC<ModalProps> = ({ setIsOpen, tokenId }) => {
  ...
  const onClickBuyChimney = async () => {
    try {
      if (!account || !mintChimneyNFTContract || !salePartsNFTContract) return;
