...
import { MINT_ROOF_NFT_CONTRACT } from "../../abis/contractAddress";
...
const Modal: FC<ModalProps> = ({ setIsOpen, tokenId }) => {
  ...
  const onClickBuyRoof = async () => {
    try {
      if (!account || !mintRoofNFTContract || !salePartsNFTContract) return;
