...
import { MINT_WALL_NFT_CONTRACT } from "../../abis/contractAddress";
...
const WallBuyModal: FC<ModalProps> = ({ setIsOpen, tokenId }) => {
  ...
  const onClickBuyWall = async () => {
    try {
      if (!account || !mintWallNFTContract || !salePartsNFTContract) return;
