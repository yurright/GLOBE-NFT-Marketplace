...
import { MINT_WINDOW_NFT_CONTRACT } from "../../abis/contractAddress";
...
const WindowBuyModal: FC<ModalProps> = ({ setIsOpen, tokenId }) => {
  ...
  const onClickBuyWindow = async () => {
    try {
      if (!account || !mintWindowNFTContract || !salePartsNFTContract) return;
