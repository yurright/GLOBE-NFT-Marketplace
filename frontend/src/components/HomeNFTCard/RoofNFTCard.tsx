...
import Modal from "../BuyModal/RoofBuyModal";
...
const RoofNFTCard: FC<NFTCardProps> = ({ image, name, tokenId }) => {
  ...
  const onClickModal = async () => {
    if (!account || !mintRoofNFTContract || !salePartsNFTContract) {
      alert("로그인하세요");
      return;
    }
